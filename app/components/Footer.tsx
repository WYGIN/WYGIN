  ...
  return(
    <footer className='p-4 bg-white sm:p-6 dark:bg-gray-900'>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://www.wygin.com/" class="hover:underline">WYGIN</a>. All Rights Reserved.</span>
